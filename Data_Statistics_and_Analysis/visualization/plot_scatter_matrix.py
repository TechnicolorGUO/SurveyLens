...
# 散点图
ax1.scatter(x_a, y_a, alpha=0.7, s=50, color='#2E86AB', edgecolors='white', linewidth=0.5)
...
ax2 = axes[0, 1]
n_bins = 15
counts, bins, patches = ax2.hist(df['Equations_density'], bins=n_bins, alpha=0.7,
...
# 设置整体标题
fig.suptitle('Scientific Paper Feature Analysis', fontsize=16, fontweight='bold', y=0.98)

# 保存为PDF，DPI=300
plt.savefig('/Users/shihaochen/Desktop/Polyu学习文件夹/YESAR2-1/SA/北辰学长课题/survey_paper_analysis.pdf',
            dpi=300, bbox_inches='tight', format='pdf')

print("图表已成功保存为: survey_paper_analysis.pdf")
print("数据统计信息:")
print(df.describe())
